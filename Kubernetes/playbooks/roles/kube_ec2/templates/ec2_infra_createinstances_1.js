 ...
 promise.then(function(result){
  ...
  ec2.describeInstances(params, function(err, data) {
    if (err) console.log(err, err.stack); // an error occurred
       ...
       var tag= '\n[kube-minions]\n';
       var buffer = "kube-minion-1 "+'ansible_ssh_user=centos ansible_ssh_private_key_file=~/keys/'+keyPairName+'.pem ansible_host='+data.Reservations[0].Instances[0].PublicDnsName+'\n';
